...
def test_create_join_request():
    ...
    response = requests.post('http://127.0.0.1:5000/joinrequest/', json={
        "creator": user_id_2,
        "team": team_id
    })
...
#     response = requests.get(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/')
...
#     assert response.status_code == 200
#     response = requests.get(f'http://127.0.0.1:5000/joinrequest/{fake_join_request_id}/')
#     assert response.content == b'Not Found'
#     assert response.status_code == 404
...
#     fake_join_request_id = '__________'
#     response = requests.patch(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/accept/')
#     assert response.status_code == 200
#     response = requests.get(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/')
#     responsenew = response.content.decode("utf-8")
#     response_body = json.loads(responsenew)
...
#     response = requests.patch(f'http://127.0.0.1:5000/joinrequest/{fake_join_request_id}/accept/')
#     assert response.content == b'Not Found'
#     assert response.status_code == 404
...
#     join_request_id = str(response_body["id"])
#     fake_join_request_id = '__________'
#     response = requests.patch(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/reject/')
#     assert response.status_code == 200
#     response = requests.get(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/')
#     responsenew = response.content.decode("utf-8")
#     response_body = json.loads(responsenew)
...
#     assert response.content == b'Conflict'
#     assert response.status_code == 409
#     response = requests.patch(f'http://127.0.0.1:5000/joinrequest/{fake_join_request_id}/reject/')
#     assert response.content == b'Not Found'
#     assert response.status_code == 404
...
#     join_request_id = str(response_body["id"])
#     fake_join_request_id = '__________'
#     response = requests.patch(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/withdraw/')
#     assert response.status_code == 200
#     response = requests.get(f'http://127.0.0.1:5000/joinrequest/{join_request_id}/')
#     responsenew = response.content.decode("utf-8")
#     response_body = json.loads(responsenew)
...
#     assert response.content == b'Conflict'
#     assert response.status_code == 409
#     response = requests.patch(f'http://127.0.0.1:5000/joinrequest/{fake_join_request_id}/withdraw/')
#     assert response.content == b'Not Found'
#     assert response.status_code == 404
