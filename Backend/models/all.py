...
class Team(db.Model):
    ...
    users = db.relationship(
        'User', secondary=associate_users_teams, back_populates='teams')
    join_requests = db.relationship(
        'Joinrequest', back_populates='team', cascade='all, delete')
...
class Project(db.Model):
    ...
    teams = db.relationship(
        'Team', back_populates='project', cascade='all, delete')
...
class Projectabout(db.Model):
    ...
    project = db.relationship(
        'Project', backref=db.backref('about', uselist=False))
...
class User(db.Model):
    ...
    join_requests = db.relationship(
        'Joinrequest', back_populates='user', cascade='all, delete')
    teams = db.relationship(
        'Team', secondary=associate_users_teams, back_populates='users')
